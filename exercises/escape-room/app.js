		...
		case 2:
			if (keyFound) {
				if (time === 0) {
					...
					console.log("\nYou use the key on the door. It's a perfect fit! You sprint out the building; it collapses just " + time + " minutes after you leave. Congratulations, you have survived!");
				}
				return;
			} else {
